...
> <br>
> 
> So http://localhost:8000/api/people/ is the URL you can use **for all the CRUD operations** <ins>without you having to bother about how actually the CRUD logic is implemented in the backend</ins>. <br>
