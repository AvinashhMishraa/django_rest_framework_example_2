...
Since you have already overridden the <code>delete()</code> method of the <code>Person</code> model, you may be thinking &nbsp;➜ <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&Nbsp;If &nbsp;<code>Person.objects.filter(id__in=ids_to_delete).delete()</code> &nbsp;does &nbsp;a <ins>**bulk soft delete**</ins> &nbsp;or &nbsp;<ins>**bulk hard delete**</ins> ?
