...
> <br>
> 
> 🔶 &nbsp;<ins>Option 1</ins> &nbsp;➜ &nbsp;Using <ins>Django's</ins> `.values()`
> 
> > ```
...
> <br>
> 
> 🔶 &nbsp;<ins>Option 2</ins> &nbsp;➜ &nbsp;<ins>List of Tuples (id, name)</ins> using `list()` function and `.values_list()` method
> 
> > ```
...
> <br>
> 
> 🔶 &nbsp;<ins>Option 3</ins> &nbsp;➜ &nbsp;<ins>List of Strings (formatted)</ins> using <ins>list comprehenssion</ins>
> 
> > ```
