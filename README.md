...
$$
\text{Page Number} \hspace{1cm} = \hspace{1.5cm} \left\lfloor \frac{\text{offset}}{\text{limit}} \right\rfloor + 1
$$


$$
\text{Content Range for Each Page} \hspace{0.2cm} = \quad [\text{offset} + 1,\ \text{offset} + \text{limit}]
$$
