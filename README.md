...
Now that you have seen custom filtering, let's go for advanced filtering techniques involving **<ins>custom method filters</ins>** where you can have **different custom methods in the flter class** &nbsp;`PersonFilter`
...
> 
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; http://localhost:8000/api/people/?name=&age_range=50-60&color_name=red
> ```
> WHERE age BETWEEN 50 AND 60 AND color.color_name ILIKE '%red%'
> ```
> 
> ```
> [
...
> > ```
> > However the URL will actually look like &nbsp; ➜ &nbsp;**GET** &nbsp; `/api/people/?search=age_range=50-60&color_name=blue`
> >
...
> - <ins>**Explicit ordering**</ins> while fetching the objects avoids the &nbsp;`UnorderedObjectListWarning`
...
**👉** &nbsp;&nbsp;<ins>**CASE 2**</ins> &nbsp;&nbsp;&nbsp;➜&nbsp;&nbsp;&nbsp; **Assuming you <ins>do not have</ins> a seperate reusable file containg** &nbsp;`CustomPagination`&nbsp; **class &nbsp;:**
