...
> >
> >  In a <code>PATCH</code> request, data will only include the fields that are being updated. If "name" is not in the request, <code>data['name']</code> will raise a **KeyError**.
> <br>
>
